    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="lg:ml-64 min-h-screen">
        <div className="max-w-2xl mx-auto p-6 lg:p-10">
          ...
          {/* Verification Badge Toggle - only for verified users */}
          {user?.verified && (
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="font-semibold">Галочка верификации</h2>
                    <p className="text-sm text-muted-foreground">
                      {user?.show_verification_badge !== false 
                ...
                <Button
                  variant={user?.show_verification_badge !== false ? "default" : "outline"}
                  onClick={toggleBadge}
                  disabled={badgeLoading}
                >
                  {badgeLoading ? "..." : user?.show_verification_badge !== false ? "Отключить" : "Включить"}
                </Button>
              </div>
            </motion.div>
          )}
