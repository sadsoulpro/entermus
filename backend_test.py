...
class BandLinkAPITester:
    def __init__(self, base_url="https://load-github-app.preview.emergentagent.com/api"):
...
def main():
    ...
    print(f"Testing against: https://load-github-app.preview.emergentagent.com/api")
