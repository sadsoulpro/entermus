...
class BandLinkAPITester:
    def __init__(self, base_url="https://musician-ogmeta.preview.emergentagent.com/api"):
...
def main():
    ...
    print(f"Testing against: https://musician-ogmeta.preview.emergentagent.com/api")
